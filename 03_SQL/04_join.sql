...
select e.emp_id,
       ...
       d.dept_name,
       d.loc
from   emp e join dept d on e.dept_id = d.dept_id	#inner join에서 inner 생략가능
...
select e.emp_id, e.emp_name, e.salary,
	   d.dept_name, d.loc
from   emp e left join dept d on e.dept_id = d.dept_id   #left join: 왼쪽에 있는 건 다 붙임
order by 4;
